package com.dougwatkinsdev.activityrecognizer;
...
public class ActivityRecognizerModule extends ReactContextBaseJavaModule {

    private final ReactApplicationContext reactContext;

    public ActivityRecognizerModule(ReactApplicationContext reactContext) {
        super(reactContext);
